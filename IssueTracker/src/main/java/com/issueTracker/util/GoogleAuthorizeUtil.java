...
public class GoogleAuthorizeUtil {
    ...
    @Value("${google.pathToApiSecrets}")
    static private final String CREDENTIALS_FILE_PATH = "/googleApiSecrets.json";
    static private final List<String> SCOPES = List.of(SheetsScopes.SPREADSHEETS);
    ...
    public static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT)
        ...
        return new AuthorizationCodeInstalledApp(flow, receiver).authorize("IssueTracker");
    }
